...
class System_Snap:
    ...
    def print_global_sessions(self):
        ...
        for i in range(start, total_sessions ):
            ...
            if i == start:
                print '\n-- Top Global Sessions (' + str(total_sessions) + ')' + self.delimiter
    ...
    def print_sessions(self):
        ...
        for i in range(start, total_sessions ):
            ...
            if i == start:
                print '\n-- Top Sessions (' + str(total_sessions) + ')' + self.delimiter
